...
export function ControlledOutboundPanel({ onAction }: { onAction: AdminAction }) {
  ...
  return <section className="space-y-4" aria-labelledby="controlled-outbound-heading">
    ...
    <p className="rounded-xl border border-amber-100 bg-amber-50/70 px-4 py-3 text-xs leading-5 text-amber-950"><strong>Mode uji internal.</strong> Membuat tautan di sini tidak mengirim email dan tidak menghubungi prospek. Pengiriman tetap dilakukan terpisah setelah disetujui penanggung jawab.</p>
